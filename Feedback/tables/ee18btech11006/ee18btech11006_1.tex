...
\hhline{|-|-|-}
	...
	{\gnumericPB{\centering}\textbf{For given case}}
...
\hhline{|---|}
	...
	&\multicolumn{1}{p{\gnumericColC}|}%
	{\gnumericPB{\centering}{$\frac{10^3 k}{(1+\frac{s}{10^4})^3}$}}

\\
\hhline{|---|}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	{\gnumericPB{\centering}Transfer Function}
	&\multicolumn{1}{p{\gnumericColB}|}%
	{\gnumericPB{\centering}{$\frac{G}{1+GH}$}}
	&\multicolumn{1}{p{\gnumericColC}|}%
	{\gnumericPB{\centering}{$\frac{\frac{10^3}{1+\frac{s}{10^4}}}{1+\frac{1}{\left(1+\frac{s}{10^4}\right)^3}}$}}
\\
\hhline{|-|-|-|}
\end{tabular}
